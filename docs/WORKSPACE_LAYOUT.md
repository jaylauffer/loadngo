...
- [day_planner.rs](/Users/jay/pudding/loadngo/task/src/day_planner.rs)
  - `split_percent`
  - `splitter_dragging`
  - min-pane layout constraints
  - drag-to-resize behavior
- [task_list.rs](/Users/jay/pudding/loadngo/task/src/task_list.rs)
...
- ratio-based split state from [day_planner.rs](/Users/jay/pudding/loadngo/task/src/day_planner.rs)
- minimum pane widths from [day_planner.rs](/Users/jay/pudding/loadngo/task/src/day_planner.rs)
- drag capture lifecycle from [day_planner.rs](/Users/jay/pudding/loadngo/task/src/day_planner.rs)
- adjust-bar cursor semantics from [task_list.rs](/Users/jay/pudding/loadngo/task/src/task_list.rs)
