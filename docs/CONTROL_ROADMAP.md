...
- button
  - [button.rs](../ui-core/src/button.rs)
- checkbox
  - [checkbox.rs](../ui-core/src/checkbox.rs)
- slider
  - [slider.rs](../ui-core/src/slider.rs)
- stepper
  - [stepper.rs](../ui-core/src/stepper.rs)
- list / selection state
  - [list.rs](../ui-core/src/list.rs)
- combo/list combo
  - [combo.rs](../ui-core/src/combo.rs)
- tree control / tree combo
  - [tree.rs](../ui-core/src/tree.rs)
- tabs
  - [tabs.rs](../ui-core/src/tabs.rs)
- static text
  - [label.rs](../ui-core/src/label.rs)
  - [text_block.rs](../ui-core/src/text_block.rs)
- images
  - [bitmap.rs](../ui-core/src/bitmap.rs)
...
- `TextAreaModel` now exists in [text_area.rs](../ui-core/src/text_area.rs)
- the dedicated desktop validation surface is
  [text_input_harness.rs](../host-desktop/src/bin/text_input_harness.rs)
...
- editor/document-layer architecture is documented in
  [TEXT_EDITOR_MODEL.md](TEXT_EDITOR_MODEL.md)
