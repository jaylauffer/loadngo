...
- blob storage in [cas.rs](/Users/jay/pudding/loadngo/data/src/cas.rs)
- fixed 32-byte `CasHash`
- current blob addressing by `blake3`
- post-quantum signature tooling above the blob layer in
  [loadngo_cas.rs](/Users/jay/pudding/sng-rusty/src/loadngo_cas.rs)
- transitional tarball/signature workflows documented in
  [loadngo-cas-cloud-howto.md](/Users/jay/pudding/sng-rusty/docs/loadngo-cas-cloud-howto.md)
...
[cas.rs](/Users/jay/pudding/loadngo/data/src/cas.rs) is fixed to a 32-byte
