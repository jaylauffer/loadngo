...
Primitive execution note:

- backend expansion should follow the primitive rollout in
  [DRAW_PRIMITIVE_MATRIX.md](DRAW_PRIMITIVE_MATRIX.md)
- Vulkan remains a future backend target, but not ahead of stabilizing the primitive contract
  across existing Metal, GLES, and DX12 paths
