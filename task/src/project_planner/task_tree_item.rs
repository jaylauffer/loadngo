...
use windows::Win32::Graphics::Gdi::{
    CreateFontIndirectW, DrawFocusRect, FrameRect, GetStockObject, Rectangle, SelectObject,
    SetBkMode, SetDCBrushColor, SetDCPenColor, ANTIALIASED_QUALITY, CLIP_DEFAULT_PRECIS, DC_BRUSH,
    DEFAULT_CHARSET, DEFAULT_PITCH, FF_DONTCARE, FW_NORMAL, HBRUSH, HDC, HFONT, HGDIOBJ, LOGFONTW,
...
const DEFAULT_SIZE: SIZE = SIZE { cx: 80, cy: 64 };
...
impl TreeItem for TaskTreeItem {
    ...
    fn to_report_xml(&self) -> String {
        ...
        format!("<task><title>{}</title></task>", title)
    }
