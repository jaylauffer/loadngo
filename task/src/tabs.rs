...
use windows::{
    ...
    Win32::{
        ...
        Graphics::Gdi::{
            ...
            SelectObject, SetBkMode, SetDCBrushColor, SetDCPenColor, SetViewportOrgEx, DC_BRUSH,
            DC_PEN, FW_BOLD, FW_NORMAL, GRADIENT_FILL_RECT_H, GRADIENT_RECT, HBRUSH, HDC, HFONT,
            HRGN, PAINTSTRUCT, TRANSPARENT, TRIVERTEX,
        },
        ...
        UI::{
            ...
            WindowsAndMessaging::{
                ...
                CREATESTRUCTW, GWL_USERDATA, HMENU, SW_HIDE, SW_SHOW, WINDOW_EX_STYLE,
                WINDOW_STYLE, WM_CREATE, WM_DESTROY, WM_LBUTTONDOWN, WM_PAINT, WM_SIZE, WM_USER,
                WNDCLASSW, WS_CHILD, WS_CLIPCHILDREN, WS_CLIPSIBLINGS, WS_EX_TRANSPARENT,
                WS_VISIBLE,
            },
        },
    },
